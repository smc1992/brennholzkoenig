...
export function useCityButtons(cityData?: CityPageData | null): CityButtonConfig {
  return useMemo(() => {
    ...
    return {
      ...
      primary_cta_url: cityData.primary_cta_url || DEFAULT_CONFIG.primary_cta_url,
      secondary_cta_text: cityData.secondary_cta_text || DEFAULT_CONFIG.secondary_cta_text,
      secondary_cta_url: cityData.secondary_cta_url || DEFAULT_CONFIG.secondary_cta_url,
      contact_phone_display: cityData.contact_phone_display || cityData.contact_phone || DEFAULT_CONFIG.contact_phone_display,
      contact_whatsapp_url: cityData.contact_whatsapp_url || DEFAULT_CONFIG.contact_whatsapp_url,
      shop_url: cityData.shop_url || DEFAULT_CONFIG.shop_url,
      contact_url: cityData.contact_url || DEFAULT_CONFIG.contact_url,
      calculator_cta_text: cityData.calculator_cta_text || DEFAULT_CONFIG.calculator_cta_text,
