...
export default function BlogContent({ slug }: BlogContentProps) {
  ...
  useEffect(() => {
    if (post?.content_value) {
      generateTableOfContents(post.content_value);
    }
  }, [post?.content_value]);
