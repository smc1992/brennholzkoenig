...
function getSupabaseAdminClient() {
  ...
  const serviceRoleKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY; // Verwende ANON_KEY für jetzt
  ...
  if (!supabaseUrl || !serviceRoleKey) {
    ...
    console.warn('NEXT_PUBLIC_SUPABASE_ANON_KEY:', serviceRoleKey ? 'SET' : 'MISSING');
    return null;
  }
