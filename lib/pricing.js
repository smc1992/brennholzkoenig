...
export const calculatePriceWithTiers = (basePrice, quantity, pricingTiers = [], minOrderQuantity = 3, hasQuantityDiscount = false) => {
...
export const getPriceInfoForQuantity = (quantity, pricingTiers = [], minOrderQuantity = 3, hasQuantityDiscount = false) => {
  if (quantity < minOrderQuantity) {
    return {
